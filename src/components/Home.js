...
export const Home = () => {
    ...
    const { products, count, pageIndex, loading, error, resultByPage, search, pageSize, precioMax, precioMin, category, rating, } = useSelector((state) => state.productPagination);
    ...
    useEffect(() => {
        ...
        dispatch(
            getProductPagination({
                pageIndex: pageIndex, //consume el valor pageIndex que esta almacenado en el redux
                pageSize: pageSize, //igual q se consuma desde el redux
                search: search,
                precioMax: precioMax,
                precioMin: precioMin,
                categoryId: category,
    ...
    }, [ dispatch, error, alert, search, pageSize, pageIndex, precioMax, precioMin, category, rating, ]); //cada vez que una de estas variables cambien, inmediantamente se dispara el getProductPagination
